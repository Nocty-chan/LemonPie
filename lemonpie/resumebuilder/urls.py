...
urlpatterns = [
    ...
    url(r'^groups/(?P<group_id>[0-9]+)/add_entry/$', views.add_entry_to_group, name='add_entry_to_group'),
    url(r'^groups/delete_entry/(?P<entry_list_id>[0-9]+)$', views.delete_entry_from_group, name='delete_entry_from_group'),
